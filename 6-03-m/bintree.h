...
public:
	...
	//Coge como menor el primer elemento y lo pasa para calcularlo recursivamente
	T menor() {
	...
	//Calcula recursivamente el menor
	void cuenta(Link a, T& menors) {
		if (a != nullptr) {
			//Si el menor actual es mayor a cualquiera, iguala este al debido.
			//Despues pasamos la recursion a ambos nodos
